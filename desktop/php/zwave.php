...
foreach (zwave::listServerZway() as $id => $server) {
	if (isset($server['name'])) {
		...
		if ($controlerState === null) {
			echo '<div class="alert jqAlert alert-danger" style="margin : 0px 5px 15px 15px; padding : 7px 35px 7px 15px;">{{Impossible de contacter le serveur zway ' . $server['name'] . '.}}</div>';
		}
	}
}
...
if ($controlerState == 1) {
	...
	echo '<center>';
	echo '<i class="fa fa-sign-in fa-rotate-90" style="font-size : 7em;color:#94ca02;"></i>';
	echo '</center>';
...
if ($controlerState == 5) {
	...
	echo '<center>';
	echo '<i class="fa fa-sign-out fa-rotate-90" style="font-size : 7em;color:#FA5858;"></i>';
	echo '</center>';
...
?>
           <div class="cursor" id="bt_syncEqLogic2" style="background-color : #ffffff; height : 200px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 160px;margin-left : 10px;" >
            <center>
        ...
        <div class="cursor" id="bt_inspectQueue2" style="background-color : #ffffff; height : 200px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 160px;margin-left : 10px;" >
            <center>
                <i class="fa fa-exchange fa-rotate-90" style="font-size : 7em;color:#767676;"></i>
            </center>
        ...
        <div class="cursor" id="bt_routingTable2" style="background-color : #ffffff; height : 200px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 160px;margin-left : 10px;" >
            <center>
                <i class="fa fa-sitemap" style="font-size : 7em;color:#767676;"></i>
            </center>
        ...
        <div class="cursor" id="bt_adminRazberry2" style="background-color : #ffffff; height : 200px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 160px;margin-left : 10px;" >
            <center>
                <i class="fa fa-cogs" style="font-size : 7em;color:#767676;"></i>
            </center>
            <span style="font-size : 1.1em;position:relative; top : 23px;word-break: break-all;white-space: pre-wrap;word-wrap: break-word;color:#767676"><center>{{Administration du zwave}}</center></span>
        </div>

        <div class="cursor" id="bt_healthRazberry2" style="background-color : #ffffff; height : 200px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 160px;margin-left : 10px;" >
            <center>
